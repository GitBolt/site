    ...
    <>
      ...
      <body style={{ lineHeight: '1.5' }}>
        <div style={{ maxWidth: '80vw', margin: '0 auto', padding: "10rem" }}>
          ...
          <p>
            We do not collect any other personal information about you, including cookies.
          </p>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>Communicate with you about your use of our extension and related services</li>
              </ul>
            </li>
          </ul>
          <p>
            We do not share your email address with any third parties, except as necessary to provide our extension and related services to you. Your purchase history is stored within the extension for your personal reference and is not shared with any third parties.
          </p>
          <p>
            StellarSOL allows you to make payments using cryptocurrency on e-commerce sites such as Amazon and Flipkart. To facilitate these payments, we may use third party vendors such as Bitrefill.com and Bidali.com to buy gift cards on behalf of our users using the cryptocurrency provided by the user. We then use automation to apply those gift cards to purchases made through our extension on behalf of the user.
          </p>
